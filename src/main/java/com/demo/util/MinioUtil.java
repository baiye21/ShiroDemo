...
public class MinioUtil {
	...
	/**
	 * @Component 注解下的类无法 @Autowired 注入为空 此类在bean加载之前就被调用了 2021/06/30 baiye <baiye_21@163.com>
	 */
	// @Autowired
	// static MinioClient minioClient = (MinioClient)
	// ApplicationContextUtils.getBean("minioClient");
	...
	public void putObject(String bucketName, MultipartFile multipartFile, String filename) {
		...
		// MinioClient minioClientTest = (MinioClient)
		// ApplicationContextUtils.getBean("MinioClient");

		// minioClientTest.putObject(bucketName, filename,
		// multipartFile.getInputStream(), putObjectOptions);
